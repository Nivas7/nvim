-- Taken from: https://github.com/MariaSolOs/dotfiles/blob/main/.config/nvim/lua/winbar.lua
...
function M.render()
    ...
    if vim.api.nvim_win_get_width(0) < math.floor(vim.o.columns / 3) then
        ...
        local special_dirs = {
            CODE = vim.env.HOME .. '/Documents/projects/',
            DOTFILES = vim.env.XDG_CONFIG_HOME,
            HOME = vim.env.HOME,
            LEETCODE = vim.env.HOME .. "/Code/LEETCODE",
        }
...
vim.api.nvim_create_autocmd('BufWinEnter', {
    ...
    callback = function(args)
        ...
        then
            vim.wo.winbar = "%{%v:lua.require'extras.winbar'.render()%}"
        end
    end,
})
